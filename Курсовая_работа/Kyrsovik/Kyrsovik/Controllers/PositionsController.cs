...
namespace Kyrsovik.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_position,Name_position,Salary")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_position,Name_position,Salary")] Position position)
        {
            if (ModelState.IsValid)
            {
